...
$Query = "SELECT OrderNo AS label, OrderDate, OrderSm, (M_131 + M_132) AS Total 
                       ...
                       GROUP BY OrderSm, OrderDate, (M_131 + M_132), OrderNo 
          ...
          //$y_positions = ''; 
          $FontSize = '14px';                  
          $ChartHeading = 'The Section # 13 productivity tons, for '.$last_day.'-'.$MonthsNames[$month_of_the_previous_day].'/'.$year_of_the_previous_day.'   (last day)';                
