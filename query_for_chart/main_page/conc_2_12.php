...
$Query = "SELECT OrderNo AS label, OrderDate, OrderSm, (M_121 + M_122) AS Total 
                       ...
                       GROUP BY OrderSm, OrderDate, (M_121 + M_122), OrderNo 
          ...
          //$y_positions = ''; 
          $FontSize = '14px';                  
          $ChartHeading = 'The Section # 12 productivity tons, for '.$last_day.'-'.$MonthsNames[$month_of_the_previous_day].'/'.$year_of_the_previous_day.'   (last day)';                
