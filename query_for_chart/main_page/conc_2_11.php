...
$Query = "SELECT OrderNo AS label, OrderDate, OrderSm, (M_111 + M_112) AS Total 
                       ...
                       GROUP BY OrderSm, OrderDate, (M_111 + M_112), OrderNo 
          ...
          //$y_positions = ''; 
          $FontSize = '14px';                  
          $ChartHeading = 'The Section # 11 productivity tons, for '.$last_day.'-'.$MonthsNames[$month_of_the_previous_day].'/'.$year_of_the_previous_day.'   (last day)';                
