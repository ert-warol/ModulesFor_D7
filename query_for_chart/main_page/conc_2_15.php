...
$Query = "SELECT OrderNo AS label, OrderDate, OrderSm, (M_151 + M_152) AS Total 
                       ...
                       GROUP BY OrderSm, OrderDate, (M_151 + M_152), OrderNo 
          ...
          //$y_positions = ''; 
          $FontSize = '14px';                  
          $ChartHeading = 'The Section # 15 productivity tons, for '.$last_day.'-'.$MonthsNames[$month_of_the_previous_day].'/'.$year_of_the_previous_day.'   (last day)';                
