...
$Query = "SELECT OrderNo AS label, OrderDate, OrderSm, (M_101 + M_102) AS Total 
                       ...
                       GROUP BY OrderSm, OrderDate, (M_101 + M_102), OrderNo 
                       ORDER BY OrderSm, OrderNo";              
           
$FontSize = '14px';                  
$ChartHeading = 'The Section # 10 productivity tons, for '.$last_day.'-'.$MonthsNames[$month_of_the_previous_day].'/'.$year_of_the_previous_day.'   (last day)';                
