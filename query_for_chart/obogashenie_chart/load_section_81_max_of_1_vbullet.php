...
function construction_diagrams() {
   ...
   unset($ResultArray);         
   $ResultArray = array();               
   $Query = "SELECT OrderNo AS Value, OrderDate, OrderSm, M_8 AS Total 
             FROM otk_ru.ru_mtn.RudaS_WM_OF1
             WHERE OrderDate = '$today_all_date'  
             GROUP BY OrderSm, OrderDate, M_8, OrderNo 
...
$Query = "SELECT IDRecNo, F_Q_8 AS Total FROM otk_ru.ru_mtn.WM_OF1 WHERE IDRecNo = 1";
