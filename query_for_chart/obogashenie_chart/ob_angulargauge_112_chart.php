...
$Query = "SELECT F_Q_4 AS Total FROM otk_ru.ru_mtn.WM_OF2 WHERE IDRecNo = 1";
...
while($Row = sqlsrv_fetch_array($QueryResult)) {
    ...
    setcookie("nagruzka_value_112", $value_speedometr, time() + 180); 
} 
