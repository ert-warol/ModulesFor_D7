...
function construction_diagrams() {
   ...
   unset($ResultArray);         
   $ResultArray = array();               
   $Query = "SELECT OrderNo AS Value, OrderDate, OrderSm, M_121 AS Total 
             FROM otk_ru.ru_mtn.RudaS_WM_OF2
             WHERE OrderDate = '$today_all_date'  
             GROUP BY OrderSm, OrderDate, M_121, OrderNo 
...
$Query = "SELECT IDRecNo, F_Q_5 AS Total FROM otk_ru.ru_mtn.WM_OF2 WHERE IDRecNo = 1";
