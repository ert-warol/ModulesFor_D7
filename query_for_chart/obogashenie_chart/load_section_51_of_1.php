...
function construction_diagrams() {
   global $period, $Year, $Month, $Day, $ChartHeading, $XaxisName, $MonthsNames, $namber_base, $line, $first_year, $Year_interval, $last_year, $line_link, $Query, $ResultArray, $number_of_days, $FontSize, $y_positions, $today_m, $today_year_all, $today_all_date, $today_year, $today_all;
          ...
          unset($ResultArray);         
          $ResultArray = array();               
          $Query = "SELECT OrderNo AS Value, OrderDate, OrderSm, M_5 AS Total 
                       FROM otk_ru.ru_mtn.RudaS_WM_OF1
                       WHERE OrderDate = '$today_all_date'  
                       GROUP BY OrderSm, OrderDate, M_5, OrderNo 
          ...
          $y_positions = '0'; 
          $FontSize = '14px';                  
          $ChartHeading = 'The Mill # 51 productivity for '.$today_all_date;
          $XaxisName = 'Hours';      
}
...
$Output ="<chart caption='$ChartHeading' xaxisname='$XaxisName' baseFontSize='14' yAxisNameFont='Calibri' captionFont='Calibri' valueFont='Calibri' subCaptionFont='calibri' baseFont='calibri' baseChartMessageFont='Calibri' pixelsperlabel='50' labelheight='10' numVisibleLabels='24' yAxisMinValue='$min_value' yAxisMaxValue='217' rotateLabels='0' yaxisname='Productivity, tn/h' xAxisNameFontSize='14' yAxisNameFontSize='14' thousandSeparatorPosition='0' numberScaleValue = '2' showlabels='1' showvalues='1' decimals='2' formatNumberScale='0' FormatNumber='0' numberprefix='' numberSuffix=' ' placevaluesinside='1' rotatevalues='1' valueFontSize='$FontSize' bgcolor='FFFFFF' legendshadow='0' legendborderalpha='50' canvasborderthickness='1' canvasborderalpha='50' palettecolors='#246624' showborder='0' theme='carbon'>"; 
...
//Generate Chart XML: Main Body
            ...
            for($j = 0; $j <= 23; $j++) { 
               ...
               $Output .= '</categories>';            
               $Output .= '<dataset seriesname="Mill 51" alpha="100" valuePosition="BELOW" anchorRadius="4">';                             
