...
function construction_diagrams() {
   ...
   unset($ResultArray);         
   $ResultArray = array();               
   $Query = "SELECT OrderNo AS Value, OrderDate, OrderSm, M_152 AS Total 
             FROM otk_ru.ru_mtn.RudaS_WM_OF2
             WHERE OrderDate = '$today_all_date'  
             GROUP BY OrderSm, OrderDate, M_152, OrderNo 
...
$Query = "SELECT IDRecNo, F_Q_12 AS Total FROM otk_ru.ru_mtn.WM_OF2 WHERE IDRecNo = 1";
