...
$Query = "SELECT F_Q_1 AS Total FROM otk_ru.ru_mtn.WM_OF2 WHERE IDRecNo = 1";
...
function construct_diagram_speedometer(){ 
   ...
   $Output = "<chart caption='  Мел. 101' captionHorizontalPadding='50' captionfont='Arial' animation='0' placeTicksInside='1' captionfontcolor='#076717' refreshInterval='180' manageresize='1' origw='300' origh='300' tickvaluedistance='5' bgcolor='#FFFFFF' upperlimit='200' lowerlimit='0' basefontcolor='#FFFFFF' majortmnumber='9' majortmcolor='#FFFFFF' majortmheight='8' majortmthickness='5' minortmnumber='5' minortmcolor='#FFFFFF' minortmheight='3' minortmthickness='2' pivotradius='10' pivotbgcolor='#000000' pivotbordercolor='#FFFFFF' pivotborderthickness='2' tooltipbordercolor='#FFFFFF' tooltipbgcolor='#333333' gaugeouterradius='114' gaugestartangle='220' gaugeendangle='-40' gaugealpha='0' decimals='0' showcolorrange='0' placevaluesinside='1' pivotfillmix='' showpivotborder='1' annrenderdelay='0' gaugeoriginx='160' gaugeoriginy='110' showborder='0'>";
   $Output .= '<dials>'; // циферблаты
   $Output .= '<dial value="'.$value_speedometr.'" bgcolor="000000" valueY="50" bordercolor="#FFFFFF" borderalpha="100" basewidth="5" topwidth="1" borderthickness="2" valuey="200" radius="70" baseRadius="30"/>';
   $Output .= '</dials>';
   $Output .= '<annotations>';
...
while($Row = sqlsrv_fetch_array($QueryResult)) {
    ...
    setcookie("nagruzka_value_101", $value_speedometr, time() + 180); 
} 
