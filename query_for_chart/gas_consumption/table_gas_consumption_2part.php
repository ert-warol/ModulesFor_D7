            ...
            $table_all .= '<tbody>';
               ...
               $table_all .= '<tr>';                
			         ...
			         for ($i = 15; $i <= $interval; $i++) {
			            ...
			            $table_all .= '<td style=" width: 100px; height: 50px; padding-right: 5px; border-bottom: none; font-size: 16px; text-align: '.$text_position.'; color: red; font-family: calibri; margin: 0; font-weight: 400;  border: 1px dotted black;">'.$value_red_line[$i].'</td>';
			         }
                $table_all .= '</tr>';
                $table_all .= '<tr>';                  
			         ...
			         for ($i = 15; $i <= $interval; $i++) {
			            ...
			            $table_all .= '<td style=" width: 100px; height: 50px; padding-right: 5px; border-bottom: none; background: rgba(70, 136, 71, 0.34); font-size: 16px; text-align: '.$text_position.'; color: blue; font-family: calibri; margin: 0; font-weight: 400;  border: 1px dotted black;">'.$value_blue_line[$i].'</td>';
			         }
                $table_all .= '</tr>';
                $table_all .= '<tr>';                  
			         ...
			         for ($i = 15; $i <= $interval; $i++) {
			            ...
			            $value_green_line[15] = 'G2 Green line';
			            $table_all .= '<td style=" width: 100px; height: 50px; padding-right: 5px; border-bottom: none; font-size: 16px; text-align: '.$text_position.'; color: green; font-family: calibri; margin: 0; font-weight: 400;  border: 1px dotted black;">'.$value_green_line[$i].'</td>';
			         }
                $table_all .= '</tr>';
                $table_all .= '<tr>';                
                     if($today_day > 19 ){
                ...
                $table_all .= '<tr>';                
			         ...
			         for ($i = 15; $i <= $interval; $i++) {
                       ...
                       $value_procent_g1[15] = 'Savings Gas G1';
                       if( $i > 15 ) {
			          $text_position = 'right';
			       }			     			
			       else {
                ...
                $table_all .= '<tr>';                
			         ...
			         for ($i = 15; $i <= $interval; $i++) {
                       ...
                       $value_procent_g1_1[15] = 'Savings Gas G1-1';
                       if( $i > 15 ) {
			          $text_position = 'right';
			       }			     			
			       else {
